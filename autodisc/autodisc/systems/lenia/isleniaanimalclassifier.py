...
class IsLeniaAnimalClassifier(ad.core.Classifier):
    ...
    def calc(self, observations, statistics=None):
        ...
        self.finite_segments_obs1, (self.segmented_image_obs1, _), _ = ad.helper.statistics.calc_is_segments_finite(obs1, tol=self.config.tol, r=self.config.r)
        ...
        if not self.finite_segments_obs1:
            ...
            if not self.animal_segments_obs1:
                ...
                self.finite_segments_obs2, (self.segmented_image_obs2, _), _ = ad.helper.statistics.calc_is_segments_finite(obs1, tol=self.config.tol, r=self.config.r)
