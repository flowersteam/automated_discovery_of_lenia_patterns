...
def get_explorer_config():
    ...
    explorer_config.goal_space_representation.config.statistics = ['activation_mass[-1]','activation_density[-1]','activation_mass_asymmetry[-1]',]
    ...
    explorer_config.goal_selection.sampling = [(0, 1),(0, 1),(-1, 1),]
