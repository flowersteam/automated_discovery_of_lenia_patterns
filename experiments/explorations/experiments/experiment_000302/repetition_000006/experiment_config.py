...
def get_explorer_config():
    ...
    explorer_config.goal_space_representation.config.initialization.model_init_params = {'n_latents': 8, 'beta': 5.0, 'add_var_to_KLD_loss': False, 'input_size': (system_params.size_y, system_params.size_x), 'num_classes': 3}
