...
def get_explorer_config():
    ...
    explorer_config.goal_space_representation.config.statistics = ['activation_mass[-1]','activation_density[-1]','activation_mass_asymmetry[-1]','activation_mass_distribution[-1]']
