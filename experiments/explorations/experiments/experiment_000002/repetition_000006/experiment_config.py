...
def get_explorer_config():
    ...
    explorer_config.goal_space_representation.config.statistics = ['activation_mass_mean']
    ...
    explorer_config.goal_selection.sampling = [(0, 1), (0, 0.4)]

    # how are the source policies for a mutation are selected
    explorer_config.source_policy_selection.type = 'random'
