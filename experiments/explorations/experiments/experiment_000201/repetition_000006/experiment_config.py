...
def get_explorer_config():
    ...
    explorer_config.goal_space_representation.config.initialization.load_from_model_path = '../../../../pre_train_imgep_pgl_goalspace/experiments/experiment_000017/training/models/best_weight_model.pth'
