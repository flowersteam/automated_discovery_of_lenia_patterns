            ...
            for repetition_idx, repetition_id in enumerate(config.experiment_repetitions):
                ...
                for class_idx in range(len(config.classes)):
                    ...
                    for run_idx in run_idxs:
                        ...
                        final_observation = obs['states'][-1]
...
if __name__ == '__main__':
    ...
    config.classes = [
        dict(ratio = 0.5, filter = ('classifier_animal.data', '==', True)),
        dict(ratio = 'remainder', filter = (('classifier_dead.data', '==', False), 'and', ('classifier_animal.data', '==', False))),
    ]
